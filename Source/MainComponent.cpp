...
MainComponent::MainComponent()
{
    ...
    addAndMakeVisible(observer);
    
    
    observer.setListener(this);
    sectionManager->setListener(&observer);
    observer.setBoolIsLoaded(sectionManager->getIsLoaded());
    ...
    type = std::async(std::launch::async, [this] { this->sectionManager->load(); });
    
}

MainComponent::~MainComponent()
{
    sectionManager->clearObject();
